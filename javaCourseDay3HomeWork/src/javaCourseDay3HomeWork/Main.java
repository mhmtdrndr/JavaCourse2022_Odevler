...
/*		//başarılı kurs kaydı
		Course course1 = new Course(1, 1, "JAVA", "(2022) Yazılım Geliştirici Yetiştirme Kampı - JAVA", "Engin Demiroğ", 0);
		
		//kurs fiyatı 0 dan küçük olduğu için hata fırlatır.
		Course course2 = new Course(1, 2, "C#", "Senior Yazılım Geliştirici Yetiştirme Kampı", "Engin Demiroğ", -1);	
